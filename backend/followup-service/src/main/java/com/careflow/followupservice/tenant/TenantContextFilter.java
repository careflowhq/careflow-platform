 ...
 * 2. This filter extracts and validates those headers for follow-up endpoints
 * 3. Service layer uses TenantContext.clinicId() to enforce tenant isolation on every operation
 */
@Component
